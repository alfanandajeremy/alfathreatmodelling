...
You MUST only respond with the Mermaid code block. See below for a simple example of the required format and syntax for your output use bahasa indonesia tanpaa membuang makna serapan.  dan berikan penjelasan atas diagram yang dibuat pada mermaid code. make all the mermaid code format consistent every generate
