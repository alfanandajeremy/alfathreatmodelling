...
def create_dread_assessment_prompt(threats):
    prompt = f"""
Act as a cyber security expert with more than 20 years of experience in threat modeling using STRIDE and DREAD methodologies. use bahasa indonesia tanpa membuang kata serapan
Your task is to produce a DREAD risk assessment for the threats identified in a threat model. and match with top 10 owasp
Below is the list of identified threats and :
{threats}
...
- "Damage Potential": An integer between 1 and 5.
- "Reproducibility": An integer between 1 and 5.
- "Exploitability": An integer between 1 and 5.
- "Affected Users": An integer between 1 and 5.
- "Discoverability": An integer between 1 and 5.
...
{{
  "Risk Assessment": [
    {{
      ...
      "Damage Potential": 5, "Damage potential yaitu seberapa besar potensi kerusakan yang terjadi jika serangan berhasil dilakukan",
      "Reproducibility": , "Reproducibility yaitu seberapa mudah untuk mereproduksi serangan",
      "Exploitability": 5, "Exploitability yaitu berapa banyak waktu, tenaga, dan keahlian yang dibutuhkan untuk mengeksploitasi ancaman",
      "Affected Users": 9, "Affected user yaitu seberapa banyak pengguna yang terpengaruh jika ancaman dieksploitasi",
      "Discoverability": 7 , "Discoverability yaitu seberapa mudah bagi seorang penyerang untuk menemukan ancaman pada sistem."
    }},
    {{
      "Threat Type": "Spoofing",
      "Scenario": "An attacker could create a fake OAuth2 provider and trick users into logging in through it.",
